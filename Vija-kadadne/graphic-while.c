...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Rocket Game=RTR018");
...
void display(void)
{
	...
	while (flag==0) {
		...
		int x1 = rand() % (30 - (-30) + 1) + (-30);
		int y1 = rand() % (85 - 70 + 1) + 70;
		int x2 = rand() % ((x1+7)-(x1-7)+1)+(x1-7);
		int y2 = rand() % ((y1-43)-(y1-35)+1)+(y1-35);
		int x3 = rand() % ((x2+7)-(x1-7)+1)+(x1-7);
		int y3 = rand() % ((y2-55)-(y2-50)+1)+(y2-50);
		int x4 = rand() % ((x1+13) - (x1-13) + 1) + (x1-13);
		int y4 = rand() % (-35 - (-50) + 1) + (-35);
